...
> **View the rendered HTML report** to see the report as an interactive page.

The sample models a management account with a realistic mixed posture: most
foundations are in place, with a few gaps and one permission error. It is
generated by the real report code through
...
| Member | Organization member but not management | 9 limited |
...
The current suite contains 167 tests and reports 95% statement coverage.
